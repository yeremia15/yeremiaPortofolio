...
function waitAndResponce(inputText) {
    ...
    switch (inputText.toLowerCase().trim()) {
        ...
        case "resume":
            ...
            break;
        case "skills":
            sendTextMessage("<span class='sk'>I can comfortably write code & queries using this following languages :<br><span class='bold'>Javascript<br>C++<br>PHP<br>Python<br>CSS<br>HTML<br>MySQL</span><br><br>I've experience with following frameworks :<span class='bold'><br>CodeIgniter<br>Django<br>Bootstrap</span><br><br>Not only in the technical side, but also i had a lot of another skills, such as : <span class='bold'><br>Microsoft Office & Google Documents (Docs, Sheets, Slides)<br>Figma<br>BPMN<br>Diagram(Flowchart, EER, Sequence, etc)<br>Git, Github, Gitlab, Bitbucket<br>NGINX<br>Google Cloud Platform (Compute Engine, Storage, SQL, etc)<br>Project Management (Agile Method)<br>Product Management</span><br><br>I usually use <span class='bold'>Windows OS</span> as daily driver on my own computer but also using <span class='bold'>Linux Ubuntu</span> too at some point in my laptop<br>OS: <span class='bold'>Windows 10</span> & <span class='bold'>Ubuntu 20</span><br>Favourite IDE: <span class='bold'>VSCode</span></span>");
            break;
